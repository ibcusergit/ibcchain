...
static const uint64_t contract_asset_id = 1;//DBX
...
class linear_vesting_asset : public contract
{
  ...
  private:
    ...
    struct vestingrule {
        ...
        int64_t vesting_amount;
        int64_t vested_amount;

        int64_t lock_time_point;
        int64_t lock_duration;
        int64_t release_time_point;
