...
[Build Status](https://github.com/ibcusergit/ibcchain/branches):

`master` | `develop`  
 --- | --- | --- | --- | ---
 [![](https://github.com/ibcusergit/ibcchain/master)](https://github.com/ibcusergit/ibcchain) | [![](https://github.com/ibcusergit/ibcchain/tree/develop)](https://github.com/ibcusergit/ibcchain) 
...
repositories can be updated with the following steps:
    ...
    git remote set-url origin https://github.com/ibcusergit/ibcchain.git
    git checkout master
...
[wiki](https://github.com/ibcusergit/ibcchain/wiki).
...
To build after all dependencies are installed:
    ...
    git clone https://github.com/ibcusergit/ibcchain.git
    cd ibcchain
...
**NOTE:** IBCChain requires an [OpenSSL](https://www.openssl.org/) version in the 1.0.x series. OpenSSL 1.1.0 and newer are NOT supported. If your system OpenSSL version is newer, then you will need to manually provide an older version of OpenSSL and specify it to CMake using `-DOPENSSL_INCLUDE_DIR`, `-DOPENSSL_SSL_LIBRARY`, and `-DOPENSSL_CRYPTO_LIBRARY`.

**NOTE:** IBCChain requires a [Boost](http://www.boost.org/) version in the range [1.57, 1.63]. Versions earlier than
...
**NOTE:** By default the witness node will start in reduced memory ram mode by using some of the commands detailed in [Memory reduction for nodes](https://github.com/ibcusergit/ibcchain/wiki/Memory-reduction-for-nodes).
...
[here](https://github.com/ibcusergit/ibcchain/blob/master/libraries/wallet/include/graphene/wallet/wallet.hpp).
...
License
-------
IBCChain Core is under the MIT license. See [LICENSE](https://github.com/ibcusergit/ibcchain/blob/master/LICENSE.txt)
